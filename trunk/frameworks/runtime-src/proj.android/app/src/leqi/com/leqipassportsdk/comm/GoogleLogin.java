...
public class GoogleLogin {
    ...
    public void signOut() {
        ...
        if (mGoogleApiClient !=null) {
            ...
            Log.i("hkl"," Disconnect With exception");
        }
    }
    ...
    public String handleSignInResult(GoogleSignInResult result) {
        ...
        Log.i("hkl","Google 登录回调"+result.toString()+"====" + result.getStatus().getStatusCode());
        String res = "" ;
        ...
        try {
            if (result.isSuccess()) {
                ...
                mUserInfo.google_user_name =acct.getDisplayName().replace("&", "###@##");
