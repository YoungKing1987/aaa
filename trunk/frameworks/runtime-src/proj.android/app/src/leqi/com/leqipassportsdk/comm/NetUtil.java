...
public class NetUtil {
     ...
     * @param callback 请求回调
     */
    public  void doPost(final String url, final String params, final HttpResponseCallBack callback) {
     ...
     * @param callback 请求回调
     */
    public  void doPost(final String url, final String params, final Map<String, String> file, final HttpResponseCallBack callback) {
    ...
    private  String post(String url, String params, Map<String, String> files) {
