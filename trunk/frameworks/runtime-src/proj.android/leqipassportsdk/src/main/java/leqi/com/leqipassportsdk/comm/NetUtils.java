...
public class NetUtils {
     ...
     * @param callback 请求回调
     */
    public static void doPost(final String url, final String params, final HttpResponseCallBack callback) {
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            Log.i("login","register success!=="+ response.toString());
     ...
     * @param callback 请求回调
     */
    public static void doPost(final String url, final String params, final Map<String, String> file, final HttpResponseCallBack callback) {
    ...
    private static String post(String url, String params, Map<String, String> files) {
