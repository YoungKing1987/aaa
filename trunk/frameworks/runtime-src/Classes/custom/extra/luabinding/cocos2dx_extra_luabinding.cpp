...
** Generated automatically by tolua++-1.0.92 on 11/05/14 15:39:44.
*/
...
static void tolua_reg_types(lua_State* tolua_S)
{
	...
	tolua_usertype(tolua_S, "CCEncode");

	tolua_usertype(tolua_S, "CCNative");
}

/* method: encodeBase64Lua of class  CCEncode */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_CCEncode_encodeBase6400
static int tolua_cocos2dx_extra_luabinding_CCEncode_encodeBase6400(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
		!tolua_isusertable(tolua_S, 1, "CCEncode", 0, &tolua_err) ||
...
#endif
	{
		...
		{
			CCEncode::encodeBase64Lua(input, inputLength);
...
/* method: decodeBase64Lua of class  CCEncode */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_CCEncode_decodeBase6400
static int tolua_cocos2dx_extra_luabinding_CCEncode_decodeBase6400(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
...
#endif
	{
		const char* input = ((const char*)tolua_tostring(tolua_S, 2, 0));
		{
			CCEncode::decodeBase64Lua(input);
...
/* method: MD5Lua of class  CCEncode */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_CCEncode_MD500
static int tolua_cocos2dx_extra_luabinding_CCEncode_MD500(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
...
#endif
	{
		...
		{
			CCEncode::MD5Lua(input, isRawOutput);
...
/* method: MD5FileLua of class  CCEncode */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_CCEncode_MD5File00
static int tolua_cocos2dx_extra_luabinding_CCEncode_MD5File00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
...
TOLUA_API int tolua_cocos2dx_extra_luabinding_open(lua_State* tolua_S)
{
	...
	tolua_cclass(tolua_S, "CCEncode", "CCEncode", "", NULL);
	tolua_beginmodule(tolua_S, "CCEncode");
	tolua_function(tolua_S, "encodeBase64", tolua_cocos2dx_extra_luabinding_CCEncode_encodeBase6400);
	tolua_function(tolua_S, "decodeBase64", tolua_cocos2dx_extra_luabinding_CCEncode_decodeBase6400);
	tolua_function(tolua_S, "MD5", tolua_cocos2dx_extra_luabinding_CCEncode_MD500);
	tolua_function(tolua_S, "MD5File", tolua_cocos2dx_extra_luabinding_CCEncode_MD5File00);
