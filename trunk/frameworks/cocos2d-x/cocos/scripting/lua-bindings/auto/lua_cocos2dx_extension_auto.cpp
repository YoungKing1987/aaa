...
int lua_cocos2dx_extension_ScrollView_stopScrolling(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::ScrollView* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_ScrollView_stopScrolling'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S) - 1;
    if (argc == 0)
    {
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_ScrollView_stopScrolling'", nullptr);
            return 0;
        }
        cobj->stopScrolling();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.ScrollView:stopScrolling", argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_ScrollView_stopScrolling'.", &tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_extension_ScrollView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ScrollView");
        ...
        tolua_function(tolua_S, "stopScrolling", lua_cocos2dx_extension_ScrollView_stopScrolling);
    tolua_endmodule(tolua_S);
...
int lua_cocos2dx_extension_TableViewCell_getCellType(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::TableViewCell* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_TableViewCell_getCellType'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 0)
	{
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_TableViewCell_getCellType'", nullptr);
			return 0;
		}
		int ret = cobj->getCellType();
		tolua_pushnumber(tolua_S, (lua_Number)ret);
		return 1;
	}
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableViewCell:getCellType", argc, 0);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_TableViewCell_getCellType'.", &tolua_err);
#endif

				return 0;
}
int lua_cocos2dx_extension_TableViewCell_setCellType(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::TableViewCell* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_TableViewCell_setCellType'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		ok &= luaval_to_int32(tolua_S, 2, &arg0, "cc.TableViewCell:setCellType");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_TableViewCell_setCellType'", nullptr);
			return 0;
		}
		cobj->setCellType(arg0);
		lua_settop(tolua_S, 1);
		return 1;
	}
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableViewCell:setCellType", argc, 1);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_TableViewCell_setCellType'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_TableViewCell(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"TableViewCell");
		...
		tolua_function(tolua_S, "getCellType", lua_cocos2dx_extension_TableViewCell_getCellType);
		tolua_function(tolua_S, "setCellType", lua_cocos2dx_extension_TableViewCell_setCellType);
    tolua_endmodule(tolua_S);
...
int lua_cocos2dx_extension_TableView_dequeueCell(lua_State* tolua_S)
{
	...
	{
		int arg0;
		ok &= luaval_to_int32(tolua_S, 2, &arg0, "cc.TableView:dequeueCell");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_TableView_dequeueCell'", nullptr);
			return 0;
...
int lua_cocos2dx_extension_TableView_getMode(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::TableView* cobj = nullptr;
	bool ok = true;
	...
	cobj = (cocos2d::extension::TableView*)tolua_tousertype(tolua_S, 1, 0);
			...
			if (!cobj)
			{
				tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_TableView_getMode'", nullptr);
				return 0;
			}
	#endif
	...
	if (argc == 0)
	{
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_TableView_getMode'", nullptr);
			return 0;
		}
		int ret = cobj->getMode();
		tolua_pushnumber(tolua_S, (lua_Number)ret);
		return 1;
	}
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableView:getMode", argc, 0);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_TableView_getMode'.", &tolua_err);
#endif

				return 0;
}

int lua_cocos2dx_extension_TableView_setMode(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::TableView* cobj = nullptr;
	bool ok = true;
	...
	if (argc == 1)
	{
		...
		ok &= luaval_to_int32(tolua_S, 2, &arg0, "cc.TableView:getMode");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_TableView_setMode'", nullptr);
			return 0;
		}
		cobj->setMode(arg0);
		lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_TableView_setMode'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_TableView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"TableView");
		...
		tolua_function(tolua_S, "getMode", lua_cocos2dx_extension_TableView_getMode);
		tolua_function(tolua_S, "setMode", lua_cocos2dx_extension_TableView_setMode);
    tolua_endmodule(tolua_S);
