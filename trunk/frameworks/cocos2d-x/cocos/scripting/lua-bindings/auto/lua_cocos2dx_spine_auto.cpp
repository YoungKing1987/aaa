...
//µ×²ãÐÞ¸Ä
/* method: getNodeForSlot of class  SkeletonAnimation */
#ifndef TOLUA_DISABLE_tolua_GameScript_SkeletonAnimation_getNodeForSlot00
static int tolua_GameScript_SkeletonAnimation_getNodeForSlot00(lua_State* tolua_S)
{
...
#endif
		{
			CCNodeRGBA* tolua_ret = (CCNodeRGBA*)self->getNodeForSlot(slotName);
			//tolua_pushusertype(tolua_S, (void*)tolua_ret, "CCNodeRGBA");
			object_to_luaval<cocos2d::CCNodeRGBA>(tolua_S, "cc.CCNodeRGBA", (cocos2d::CCNodeRGBA*)tolua_ret);
		}
	}
	return 1;
#ifndef TOLUA_RELEASE
...
int tolua_GameScript_SkeletonAnimation_getAnimationDuration(lua_State* tolua_S)
{
	int argc = 0;
	spine::SkeletonAnimation* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonRenderer_getAnimationDuration'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		ok &= luaval_to_std_string(tolua_S, 2, &arg0, "sp.SkeletonAnimation::getAnimationDuration");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'tolua_GameScript_SkeletonAnimation_getAnimationDuration'", nullptr);
			return 0;
		}
	...
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:getAnimationDuration", argc, 1);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'tolua_GameScript_SkeletonAnimation_getAnimationDuration'.", &tolua_err);
#endif

				return 0;
}

int tolua_GameScript_SkeletonAnimation_getEventTime(lua_State* tolua_S)
{
	int argc = 0;
	spine::SkeletonAnimation* cobj = nullptr;
	bool ok = true;
	...
	if (argc == 2)
	{
		std::string arg0;
		std::string arg1;
		ok &= luaval_to_std_string(tolua_S, 2, &arg0, "sp.SkeletonAnimation::getEventTime");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'tolua_GameScript_SkeletonAnimation_getEventTime'", nullptr);
			return 0;
		}
		ok &= luaval_to_std_string(tolua_S, 3, &arg1, "sp.SkeletonAnimation::getAnimationDuration");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'tolua_GameScript_SkeletonAnimation_getEventTime'", nullptr);
			return 0;
	...
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:getEventTime", argc, 2);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'tolua_GameScript_SkeletonAnimation_getEventTime'.", &tolua_err);
#endif

				return 0;
}

int lua_cocos2dx_spine_SkeletonAnimation_createFromCache(lua_State* tolua_S)
{
	int argc = 0;
	bool ok = true;
#if COCOS2D_DEBUG >= 1
	...
	do
	{
		if (argc == 1)
		{
			...
			spine::SkeletonAnimation* ret = spine::SkeletonAnimation::createFromCache(arg0);
			object_to_luaval<spine::SkeletonAnimation>(tolua_S, "sp.SkeletonAnimation", (spine::SkeletonAnimation*)ret);
			return 1;
		}
	} while (0);
...
int lua_cocos2dx_spine_SkeletonAnimation_readSkeletonDataToCache(lua_State* tolua_S)
{
	int argc = 0;
	bool ok = true;
#if COCOS2D_DEBUG >= 1
	...
	do
	{
		if (argc == 3)
		{
			...
			if (!ok) { break; }
			std::string arg2;
			ok &= luaval_to_std_string(tolua_S, 4, &arg2, "sp.SkeletonAnimation:createWithJsonFile");
			if (!ok) { break; }
			auto ret = spine::SkeletonAnimation::readSkeletonDataToCache(arg0, arg1, arg2,1.0);
			//object_to_luaval<spine::SkeletonAnimation>(tolua_S, "sp.SkeletonAnimation", (spine::SkeletonAnimation*)ret);
			lua_settop(tolua_S, 1);
			return 1;
		}
	...
	do
	{
		if (argc == 4)
		{
			...
			if (!ok) { break; }
			std::string arg3;
			ok &= luaval_to_std_string(tolua_S, 4, &arg3, "sp.SkeletonAnimation:createWithJsonFile");
			if (!ok) { break; }
			double arg2;
			ok &= luaval_to_number(tolua_S, 5, &arg2, "sp.SkeletonAnimation:createWithJsonFile");
			if (!ok) { break; }
			auto ret = spine::SkeletonAnimation::readSkeletonDataToCache(arg0, arg1, arg3, arg2);
			lua_settop(tolua_S, 1);
			return 1;
		}
	} while (0);
...
int lua_cocos2dx_spine_SkeletonAnimation_removeAllSkeletonData(lua_State* tolua_S)
{
 	int argc = 0;
	bool ok = true;
...
int lua_cocos2dx_spine_SkeletonAnimation_removeSkeletonData(lua_State* tolua_S)
{
	int argc = 0;
	bool ok = true;
#if COCOS2D_DEBUG >= 1
	...
	do
	{
		if (argc == 1)
		{
			...
			bool ret = spine::SkeletonAnimation::removeSkeletonData(arg0);
			tolua_pushboolean(tolua_S, (bool)ret);
			return 1;
		}
	} while (0);
...
int lua_cocos2dx_spine_SkeletonAnimation_isExistSkeletonDataInCache(lua_State* tolua_S)
{
	int argc = 0;
	bool ok = true;
#if COCOS2D_DEBUG >= 1
	...
	do
	{
		if (argc == 1)
		{
			...
			bool ret = spine::SkeletonAnimation::isExistSkeletonDataInCache(arg0);
			tolua_pushboolean(tolua_S, (bool)ret);
			return 1;
		}
	} while (0);
...
int lua_register_cocos2dx_spine_SkeletonAnimation(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonAnimation");
		...
		tolua_function(tolua_S, "getNodeForSlot", tolua_GameScript_SkeletonAnimation_getNodeForSlot00);
		tolua_function(tolua_S, "getAnimationDuration", tolua_GameScript_SkeletonAnimation_getAnimationDuration);
		tolua_function(tolua_S, "getEventTime", tolua_GameScript_SkeletonAnimation_getEventTime);
